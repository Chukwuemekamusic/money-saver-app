...
export const activateUserURL = (uidb64, token) =>
  baseURL + `auth/activate/${uidb64}/${token}`;
...
export const selectAmountURL = (id) =>
  baseURL + `savings/weekly-amounts/${id}/select`;

// Statistics endpoint
export const getUserStatsURL = baseURL + "savings/stats";

// Schedule status endpoint
export const planScheduleStatusURL = (id) =>
  baseURL + `savings/plans/${id}/schedule-status`;
