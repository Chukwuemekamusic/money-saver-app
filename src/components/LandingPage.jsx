    ...
    <div className="container mx-auto px-4 py-4">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600 mb-6 max-w-2xl mx-auto">
          Set a goal, get fun weekly amounts, track your progress. Our random
          savings approach makes reaching your financial goals
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Choose your savings target and timeline. Whether it's $500 for a
              vacation or $5000 for an emergency fund.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Get randomly generated weekly amounts that add up to your goal.
              Makes saving fun and unpredictable!
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Mark weeks as complete and watch your progress grow. Get reminders
