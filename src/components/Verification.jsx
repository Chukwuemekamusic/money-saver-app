    ...
    const handleEmailVerification = async () => {
      try {
        ...
        if (type === "signup" || type === "email_change") {
          ...
          setMessage(
            "Password reset link is valid. You can now set a new password."
          );
          setTimeout(() => {
          ...
          <div className="mb-4">
            ...
            >
              ...
              <path
                className="opacity-75"
                fill="currentColor"
                d="M24 4C12.95 4 4 12.95 4 24s8.95 20 20 20 20-8.95 20-20S35.05 4 24 4zM24 14c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2s2-.9 2-2v-8c0-1.1-.9-2-2-2zm0 14c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"
              ></path>
            </svg>
